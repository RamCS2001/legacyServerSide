...
app.get('/getParticipantNumberCount', async (req,res)=>{

    // events={tamildebate : 1, martialarts: 1}
    events= ["tamildebate", "martialarts"]
    numbers=[]
    let doc
    doc = await User.countDocuments({tamildebate: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({martialarts: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({bestmanager: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({voiceoflegacy: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({musicunplugged: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({kavithaigal: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({pixie: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({yoga: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({debateguru: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({makeyourmove: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({extempore: 1}) 
    numbers.push(doc)
    doc = await User.countDocuments({pencilsketching: 1}) 
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 12})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 13})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 14})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 15})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 16})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 17})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 18})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 19})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 20})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 21})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 22})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 23})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 24})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 25})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 26})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 27})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 28})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 29})
    numbers.push(doc)
    doc= await groupEvents.countDocuments({event: 30})
    numbers.push(doc)
    
    return res.json({message: 1, count: numbers})
})
